...
# pyinstaller --add-data "assets;assets" --add-data "view/css;view/css" --add-data "view/TelasAdmin/css;view/TelasAdmin/css" --add-data "view/TelasLeitor/css;view/TelasLeitor/css" --hidden-import textual.widgets._tab_pane --name Biblioteca Main.py
